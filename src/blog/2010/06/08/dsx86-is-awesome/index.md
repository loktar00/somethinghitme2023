...
If this is something that interests you theres a [compatibility list where users are encouraged to test games to help out the development.](http://dsx86compatibility.pbworks.com/Compatibility-List) Of course you'll need some sort of DS card with custom firmware such as the R4 or Cyclo DS (my personal choice).
